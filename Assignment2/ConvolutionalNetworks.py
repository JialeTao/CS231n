...
bn_param = {'mode': 'train'}
fx = lambda p: spatial_batchnorm_forward(x, gamma, beta, bn_param)[0]
fg = lambda p: spatial_batchnorm_forward(x, gamma, beta, bn_param)[0]
fb = lambda p: spatial_batchnorm_forward(x, gamma, beta, bn_param)[0]
